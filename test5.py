...
plt.title(r'PM$_{2.5}$ concentration: Gravimetric vs Simulated', fontsize=16, fontname='Arial', y=1.03)
# plt.title('Imposing OM/OC = 2.5 Threshold', fontsize=18, fontname='Arial', y=1.03)
plt.xlim([-3, 90])
plt.ylim([-3, 90])
plt.xticks([0, 30, 60, 90], fontname='Arial', size=18)
plt.yticks([0, 30, 60, 90], fontname='Arial', size=18)
...
# Set labels
plt.xlabel(r'Gravimetric PM$_{2.5}$ (µg/m$^3$)', fontsize=18, color='black', fontdict={'fontname': 'Arial'})
plt.ylabel(r'Simulated PM$_{2.5}$ (µg/m$^3$)', fontsize=18, color='black', fontdict={'fontname': 'Arial'})
# Show the plot
plt.tight_layout()
plt.savefig(out_dir + 'PM2.5_Aaron_vs_updatedResidual_SPARTAN_AnnualMean.svg', dpi=300)
