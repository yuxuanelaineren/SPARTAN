...
scatterplot = sns.scatterplot(x='obs', y='sim', data=compr_df, s=100, alpha=1, style='source', markers=markers, hue='color', palette=['blue', 'red'], edgecolor='k')
...
# source_legend_handles = [handles[1], handles[2]]  # Select the handles for source only (excluding color handles)
# source_legend_labels = [labels[1], labels[2]]    # Select the labels for source only
# scatterplot.legend(handles=source_legend_handles, labels=source_legend_labels, title='Source', fontsize=12, title_fontsize=12)
