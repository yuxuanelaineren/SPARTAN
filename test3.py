...
slope_1, intercept_1, r_value_1, p_value_1, std_err_1 = stats.linregress(compr_df['obs'], compr_df['sim'])
...
sns.regplot(x='obs', y='sim', data=compr_df,
            scatter=False, ci=None, line_kws={'color': 'black', 'linestyle': '-', 'linewidth': 1}, ax=ax)
...
plt.text(0.05, 0.5, f'y = {slope_1:.2f}x {intercept_sign_1} {intercept_display_1:.2f}\n$r^2$ = {r_value_1 ** 2:.2f}',
...
# show the plot
plt.tight_layout()
plt.savefig(out_dir + 'FigS6b_b_r_Scatter_{}_{}_{}_Sim_vs_SPARTAN_{}_{:02d}_AnnualMean.tiff'.format(cres, inventory, deposition, species, year), dpi=600)
plt.show()
