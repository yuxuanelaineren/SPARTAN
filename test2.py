...
compr_df['obs'] = (6/7) * compr_df['obs']
compr_df['obs_se'] = (6/7) * compr_df['obs_se']
...
x_range_1 = [compr_df['obs'].min(), 2.4*(6/7)]
x_range_2 = [2.4*(6/7), compr_df['obs'].max()]
...
plt.plot([-0.5, 5.7], [-0.5, 5.7], color='grey', linestyle='--', linewidth=1, zorder=1)
# # Add error bars
...
# Show the plot
plt.tight_layout()
plt.savefig(out_dir + 'FigS2_Scatter_{}_{}_{}_Sim_vs_SPARTAN_{}_{:02d}_AnnualMean_MAC7_HIPS.svg'.format(cres, inventory, deposition, species, year), dpi=300)
plt.show()