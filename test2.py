...
sns.scatterplot(x='Elevation_meters', y='diff_f_c360', data=diff_df, hue='city', palette=city_palette, s=80, alpha=1, ax=ax, edgecolor='k', marker='o')
# Plot 'difference_c720' as triangles
sns.scatterplot(x='Elevation_meters', y='diff_f_c720', data=diff_df, hue='city', palette=city_palette, s=80, alpha=1, ax=ax, edgecolor='k', marker='^')
...
plt.title(f'BC Comparison: Normalized Difference vs Elevation',
...
# show the plot
plt.tight_layout()
plt.savefig(out_dir + 'Scatter_c720_c360_BC_Normalized_Difference_Elevation_2018.tiff', dpi=600)
