...
compr_df = pd.read_csv(os.path.join(out_dir + 'C720_HTAP_LUO_Sim_vs_C360_HTAP_LUO_Sim_BC_201807_MonMean.csv'))
...
# Show the plot
plt.tight_layout()
plt.savefig(out_dir + 'FigS3_Scatter_c720_vs_c360_201807.svg', dpi=300)
