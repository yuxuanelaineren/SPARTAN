...
scatterplot = sns.scatterplot(x='obs', y='sim', data=compr_df, s=60, alpha=1, style='source', markers=markers, hue='color', palette=['blue', 'red'], edgecolor='k')
...
spartan_legend = mlines.Line2D([], [], color='k', marker='o', linestyle='None', markersize=8, label='SPARTAN')
other_legend = mlines.Line2D([], [], color='k', marker='s', linestyle='None', markersize=8, label='other')
legend = plt.legend(handles=[spartan_legend, other_legend], fontsize=12, title_fontsize=12, frameon=False, loc='lower right')
